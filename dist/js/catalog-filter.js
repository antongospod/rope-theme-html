;(function () {
    ...
    catalogNav.forEach(el => {
            el.addEventListener('click', function (e) {
                ...
                let item = myLib.closestItemByClass(target, 'js-catalog-nav-list-item');

                if (item === null || item.classList.contains('side-menu__item--active')) {
                    return;
                }
                e.preventDefault();
                ...
                let previousBtnActive = el.querySelector('.side-menu__item--active');
